...
%
In this paper, a more general approach is considered. It is based on sampling algorithms relying on \emph{selection rules} applied to an ensemble of trajectories, and designed to sample rare events of some observable with a higher frequency. It is suited for any Markov dynamics, for example stochastic ones including diffusions or stochastic differential equations, but also potentially for chaotic deterministic dynamical systems, for example turbulent flow equations as studied in this work.
%    
%
...
More importantly, these types of algorithms have been shown to be useful for the study of rare events in simple deterministic dynamics~\cite{wouters2016rare}.
%
