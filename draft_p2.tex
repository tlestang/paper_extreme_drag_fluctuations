...
% Introduction of AMS
%
The \acl{ams} algorithm~\cite{cerou_adaptive_2007} builds on previous ideas of {splitting algorithms} \cite{KahnHarris1951}.
...
a sequence of shorter excursions \cite{glasserman_multilevel_1999,rolland_statistical_2015}.
...
{Let us mention that we use a specific form of the \ac{ams}, in which trajectories have a fixed duration $T_a$.
  It can however be formulated in terms of the ``classical \ac{ams}''~\cite{lestang_computing_2018}.
