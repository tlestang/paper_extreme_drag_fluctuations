...
mu_and_sigma_file = join(str(main_data_path), "musigma_AVG_10.dat")
...
for k in [0.005, 0.01]:
    GKTL_dir_template = join(prefix, "gktl_test_{}_k_{}_T_{}".format(N,k,Ta))
...
direct_sampling_file=join(prefix, "rt_Nc1024_Ta30_T10.csv")
