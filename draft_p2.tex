...
Table~\ref{tbl:nbTraj_tbl} shows that the \ac{gktl} algorithm is able to sample fluctuations of the time-averaged drag that could not be sampled through a direct sampling with equal computational cost.
